...
@section('title')
    Admin - {{ __('crud.admin.agents.index') }}
@endsection

@section('heading')
    {{ __('crud.admin.agents.index') }}
@endsection

@section('content')
    <x-indexPageSearch :addBtnRoute="route('admin.agent.create')" :addBtnText="__('crud.admin.agents.create')"></x-indexPageSearch>
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 dark:text-gray-400 dark:bg-gray-800 py-3">
                                <div class="flex items-center text-sm">
                                    ...
                                    <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                        ...
                                        src="{{ $agent->avatar ? asset('storage/'.$agent->avatar) : "https://images.unsplash.com/flagged/photo-1570612861542-284f4c12e75f?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=200&fit=max&ixid=eyJhcHBfaWQiOjE3Nzg0fQ" }}"
                                        alt=""
                                        loading="lazy"
                                        />
                            ...
                            <td>
                                <div class="flex items-center justify-center">
                                    {{-- <x-buttons.show :link="route('admin.admin.show', $agent)"></x-buttons.show> --}}
                                    <x-buttons.edit :link="route('admin.agent.edit', $agent)"></x-buttons.edit>
                                    <x-buttons.delete :link="route('admin.agent.destroy', $agent)"></x-buttons.delete>
                                </div>
                            </td>
                        </tr>
                    @empty
